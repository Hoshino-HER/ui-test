  ...
  return (
    <div>
      <svg width={width} height={height}>
        ...
        <rect x={0} y={0} width={width} height={height} fill={`url(#${GRADIENT_ID})`} rx={4} />
        <AreaChart
...
function BrushHandle({ x, y, height, isBrushActive }: BrushHandleRenderProps) {
  ...
  return (
    <Group left={x + pathWidth / 2} top={(height - pathHeight) / 2}>
      <path
        fill="#f2f2f2"
        d="M -4.5 0.5 L 13.5 0.5 L 3.5 15.5 L -4.5 15.5 L -4.5 0.5 M -1.5 4 L -1.5 12 M 0.5 4 L 0.5 12"
        stroke="#999999"
        strokeWidth="1"
